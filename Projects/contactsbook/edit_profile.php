...
<form method="POST" action="<?php echo SITEURL . 'actions/update_profile_action.php'; ?>" enctype="multipart/form-data">
	...
	<div class="form-group">
		...
		<input type="text" name="email" class="form-control" placeholder="" value= "<?php echo $userInfo['email']; ?>">
    ...
    <div class="form-group">
        <button type="submit" name="update_profile" class="btn btn-block btn-success "> Update</button>
    </div>   
